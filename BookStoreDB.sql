...
INSERT INTO BOOK(bookID, tobID, bookName, bookAuthor, bookPrice, bookPublishedYear, bookQuantity)
    VALUES  ('A0001', 'TB001', N'Chiến Thắng Con Quỷ Trong Bạn', N'Napoleon Hill', 115000, 2011, 12),
            ('A0002', 'TB003', N'Nghệ Thuật Tư Duy Phản Biện', N'Albert Rutherford',129000, 2021, 11),
            ('A0003', 'TB005', N'Không gia đình (Tái Bản 2019)', N'Hector Malot', 104000, 2021, 23),
            ('A0004', 'TB001', N'Nghìn Lẻ Một Đêm (Bìa cứng)', N'Antoine Galland', 990000, 2021, 33),
            ('A0005', 'TB005', N'Rừng Na Uy (Tái Bản Lần 4)', N'Haruki Murakami', 145000, 2018, 21),
            ('A0006', 'TB001', N'Ông Già Và Biển Cả', N'Ernest Hemingway', 70400, 2018, 25),
            ('A0007', 'TB005', N'Giết Con Chim Nhại (Bìa cứng)', N'Harper Lee', 110000, 2021, 34),
            ('A0008', 'TB007', N'Nhà Giả Kim (Tái Bản 2020)', N'Paulo Coelho', 63200, 2020, 4),
            ('A0009', 'TB001', N'Ba Người Lính Ngự Lâm', N'Alexandre Dumas', 156000, 2019, 28),
            ('A0010', 'TB005', N'Không Gia Đình (Phiên Bản Mới)', N'Hector Malot', 132000, 2021, 32),
            ('A0011', 'TB002', N'Hoàng Tử Bé (Tái Bản 2019)', N'Antoine De Saint-Exupéry', 75000, 2019, 55),
            ('A0012', 'TB002', N'Tôi Thấy Hoa Vàng Trên Cỏ Xanh', N'Nguyễn Nhật Ánh', 113500, 2018, 56),
            ('A0013', 'TB006', N'Nói Chuyện Là Bản Năng, Giữ Miệng Là Tu Dưỡng, Im Lặng Là Trí Tuệ', N'Trương Tiếu Hằng', 129000, 2019, 52),
            ('A0014', 'TB006', N'Thông Điệp Của Nước', N'Masaru Emoto', 89000, 2020, 21),
            ('A0015', 'TB003', N'Thông Điệp Từ Những Biểu Cảm Và Ngôn Ngữ Cơ Thể', N'Kỷ Vũ', 94000, 2019, 31),
            ('A0016', 'TB003', N'Người Nhạy Cảm Trong Thế Giới Vô Cảm', N'Ilse Sand', 85000, 2021, 35),
            ('A0017', 'TB003', N'Gửi bạn, người có trái tim vô cùng nhạy cảm', N'Jeon Hong Jin', 89640, 2021, 36),
            ('A0018', 'TB003', N'Xé vài trang thanh xuân, đổi lấy một bản thân nỗ lực', N'Văn Cát Nhi', 96000, 2021, 42),
            ('A0019', 'TB006', N'Omoiyari - Nghệ Thuật Đối Nhân Xử Thế Của Người Nhật', N'Erin Niimi Longhurst', 142000, 2020, 51),
            ...
            ('A0029', 'TB006', N'Cân Bằng Cảm Xúc, Cả Lúc Bão Giông', N'Richard Nicholls', 105000, 2020, 19),
